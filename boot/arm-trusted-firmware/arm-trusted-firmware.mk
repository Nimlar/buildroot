...
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += TRUSTED_BOARD_BOOT=1 GENERATE_COT=1 MBEDTLS_DIR=$(MBEDTLS_DIR)
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += mbedtls
endif

ifeq ($(BR2_TARGET_ARM_TRUSTED_FIRMWARE_ENCRYPT_BL32),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += DECRYPTION_SUPPORT=aes_gcm ENCRYPT_BL32=1 ENC_KEY=$(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_ENCRYPT_BL32_KEY)) ENC_NONCE=$(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_ENCRYPT_BL32_NONCE))
...
ifeq ($(BR2_TARGET_ARM_TRUSTED_FIRMWARE_UBOOT_DTB_AS_BL33_CFG),y)
ARM_TRUSTED_FIRMWARE_UBOOT_DTB = $(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_UBOOT_BL33_DTB))
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += BL33_CFG=$(BINARIES_DIR)/$(ARM_TRUSTED_FIRMWARE_UBOOT_DTB)
endif
